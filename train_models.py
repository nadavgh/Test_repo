...
def baseline_MLP(data_type='basic'):
    ...
    if data_type == 'basic':
        ...
        train_data = get_input('train', model='baseline').fillna(0)
        test_data = get_input('test', model='baseline').fillna(0)
    else:
        layers = (100, 200, 100)
...
def flattened_data_MLP(data_type='basic'):
    if data_type == 'basic':
        train_data = get_input('train', model='flattened')
        test_data = get_input('test', model='flattened')
    else:
